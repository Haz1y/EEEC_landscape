...
include { RESCUE_INDELOCATOR } from './python.nf' addParams( outdir: params.outdir+"/3.rescue_indelocator_14_8_0.01_0.05", publish_enable: true, publish_dir_mode: params.publish_dir_mode)
include { INDELOCATORVCF2MAF } from '../modules/tools/vcf2maf' addParams( outdir: params.outdir+"/4.rescue_indelocator_maf_14_8_0.01_0.05", publish_enable: true, publish_dir_mode: params.publish_dir_mode)
...
//include { VCF_MERGE } from '../modules/tools/vcf_merge' addParams( outdir: params.outdir+"/9.merge_snv_indel_minN2_vcf", publish_enable: true, publish_dir_mode: params.publish_dir_mode)
//include { COVERVCF2MAF } from '../modules/tools/vcf2maf' addParams( outdir: params.outdir+"/10.merge_snv_indel_minN2_maf", publish_enable: true, publish_dir_mode: params.publish_dir_mode)
