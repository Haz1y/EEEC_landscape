...
include { YARA_MAPPING } from '../modules/tools/yara' addParams( outdir: params.outdir, publish_enable: true, publish_dir_mode: params.publish_dir_mode)
include { OPTITYPE } from '../modules/tools/optitype' addParams( outdir: params.outdir, publish_enable: true, publish_dir_mode: params.publish_dir_mode)
